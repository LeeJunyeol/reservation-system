...
<body data-id=${id}>
    <div id="container">
        ...
        <div class="ct">
            <div class="ct_wrap">
              ...
              <div class="section_product_detail">
              </div>
                  ...
                  <div class="form_wrap">
                      ...
                      <form class="form_horizontal">
                          ...
                          <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary">필수</span> <span>연락처</span> </label>
                              <div class="inline_control"> <input type="tel" name="tel" id="tel" class="tel" value="010" placeholder="휴대폰 입력 시 예매내역 문자발송"> </div>
                          </div>
    ...
    <script type="text/handlebars-template" id="product-detail-template">
      <div class="group_visual">
          <div class="container_visual" style="width: 414px;">
              <ul class="visual_img">
                  <li class="item" style="width: 414px;">
                      <img alt="" class="img_thumb" src="/api/images/{{mainImageId}}"> <span class="img_bg"></span>
      ...
      <div class="section_store_details">
          <div class="store_details">
              ...
              <p class="dsc">
                  장소 : {{placeName}}<br> 기간 : {{displayPeriod}}
              </p>
        ...
        <div class="ticket_body">
          {{#each this}}
            <div class="qty" data-price-type={{priceType}} data-price={{discountedPrice}}>
                ...
                <strong class="product_price"> <span class="price">{{localePrice}}</span> <span class="price_type">원</span> </strong>
                <em class="product_dsc">{{localeDiscountedPrice}}원 ({{discountRate}}% 할인가)</em>
                </div>
            </div>
          {{/each}}
        </div>
